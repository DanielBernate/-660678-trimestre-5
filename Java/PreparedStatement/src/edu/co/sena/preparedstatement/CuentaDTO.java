...
public class CuentaDTO implements java.io.Serializable{
    ...
    public String toString() {
        return "CuentaDTO{" + "tipoDocumento=" + tipoDocumento + ", numeroDocumento=" + numeroDocumento + ", primerNombre=" + primerNombre + ", segundoNombre=" + segundoNombre + ", primerApellido=" + primerApellido + ", segundoApellido=" + segundoApellido + ", contasena=" + contasena + ", email=" + email + ", usuario_idUsuario=" + usuario_idUsuario + '}';
    }
