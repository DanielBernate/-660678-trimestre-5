...
public class DomicilioCuentaDaoSample
{
	...
	DomicilioCuenta domici1 = new DomicilioCuenta();
        domici1.setCuentaTipodocumento("CC");
        domici1.setCuentaNumerodocumento("324569885");
        domici1.setTelefono("3132758");
        domici1.setBarrio("Bochica");
        domici1.setDireccion("Calle 23 sur");
        domici1.setLocalidad("Rafael Uribe");
        domici1.setMunicipioIdmunicipio("514");
        
        DomicilioCuentaDao daoDomicilio = getDomicilioCuentaDao();
        daoDomicilio.insert(domici1);
        findAll();
        }
