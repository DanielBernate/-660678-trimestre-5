...
public class ProductoDaoSample
{
	...
	Producto producto1 = new Producto();
        ...
        producto1.setMarca("Yamahha");
        producto1.setReferencia("T120");
        producto1.setDescripcion("Es un istrumentos hecho a mano de una manera artesanal");
        producto1.setMaterial("Koa");
        producto1.setColor("Negro");
        producto1.setCantidad(6);
        producto1.setActivo(new Short("1"));
        producto1.setPrecioUnitario(150000);
        producto1.setDescuento(0);
        producto1.setCategoriaIdcategoria(1);
        producto1.setCatalogoIdcatalogo(1);
        
        ProductoDao daoProducto = getProductoDao();
