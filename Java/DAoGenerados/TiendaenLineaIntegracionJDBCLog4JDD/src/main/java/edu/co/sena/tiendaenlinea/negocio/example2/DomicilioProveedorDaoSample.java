...
public class DomicilioProveedorDaoSample
{
	...
	DomicilioProveedor domiprove = new DomicilioProveedor();
        domiprove.setProveedorIdproveedor("DA123");
        domiprove.setProveedorTipodeidentificacion("CC");
        domiprove.setTelefono("123456789");
        domiprove.setDireccion("Calle 34 sur 12 b");
        domiprove.setBarrio("Martires");
        domiprove.setLocalidad("14");
        domiprove.setMunicipioIdmunicipio("524");
        
            DomicilioProveedorDao daoDomicilioPrve = getDomicilioProveedorDao();
            daoDomicilioPrve.insert(domiprove);
            findAll();
