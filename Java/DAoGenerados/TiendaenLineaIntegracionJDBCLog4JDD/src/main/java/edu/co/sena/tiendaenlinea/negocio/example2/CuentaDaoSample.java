	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereUsuarioIdusuarioEquals("");
	           Cuenta cuenta1 = new Cuenta();
                   ...
                   cuenta1.setNumeroDocumento("324569885");
                   cuenta1.setPrimerNombre("Daniel");
                   cuenta1.setSegundoNombre("Alejandro");
                   cuenta1.setPrimerApellido("Bernate");
                   cuenta1.setSegundoApellido("Penuela");
                   cuenta1.setContrasena("123456");
                   cuenta1.setEmail("Dabe@hotmail.com");
                   cuenta1.setUsuarioIdusuario("DaBe95");
