...
public class InventarioDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereProveedorTipodeidentificacionEquals("");
            ...
            inventario1.setFecha(null);
            inventario1.setCantidad(6);
            inventario1.setProductoIdproducto("A001");
            inventario1.setProveedorIdproveedor("DA123");
            inventario1.setProveedorTipodeidentificacion("CC");
            
            InventarioDao daoInventario = getInventarioDao();
            daoInventario.insert(inventario1);
            findAll();
	}
